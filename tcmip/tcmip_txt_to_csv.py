...
def find_component_folder():
    for name in os.listdir('.'):
        if os.path.isdir(name) and name.lower().startswith('tcmip'):
            return name
...
def main():
    ...
    fields = ['Ingredient Name in English', 'Molecular Formula', 'Molecular Weight', 'CAS No.', 'External Link to PubChem', 'External Link to ChEMBL']
